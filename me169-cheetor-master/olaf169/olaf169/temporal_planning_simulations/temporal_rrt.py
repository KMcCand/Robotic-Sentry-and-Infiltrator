...
# WAYPOINTS = ((10, 6), (4, 6), (4.5, 2), (8, 1)) # Sentry close to you, have to get out of the way immediately
# WAYPOINTS = ((4.5, 2), (4, 6), (10, 6), (8, 1)) # Sentry slow and go through the corridor configuration
global WAYPOINTS
global SENTRY_EXPECTED_SPEED
WAYPOINTS = ((5, 7), (11, 7), (11, 3), (5, 3))
SENTRY_EXPECTED_SPEED = 2.4
...
class Node:
    ...
    def inFreespace(self):
        ...
        for triangle in triangles:
            if PointNearTriangle(0.5, (self.x, self.y), triangle):
                return False
        return True
    ...
    def check_sentry_collision(self, other):
        ...
        for alpha in np.arange(0.0, 1.0, 0.005): # checks 10 intermediate points in connects to
            ...
            #     return True
            if PointNearTriangle(0.5, inter_pt, get_sentry_triangle(inter_t - SENTRY_LAG)):
                return True
    ...
    def connectsTo(self, other):
        ...
        for triangle in triangles:
            if SegmentCrossTriangle(((self.x, self.y), (other.x, other.y)), triangle):
                return False
...
class Visualization:
    def __init__(self):
        ...
        plt.plot((WAYPOINTS[0][0], WAYPOINTS[1][0], WAYPOINTS[2][0], WAYPOINTS[3][0], WAYPOINTS[0][0]),
                    (WAYPOINTS[0][1], WAYPOINTS[1][1], WAYPOINTS[2][1], WAYPOINTS[3][1], WAYPOINTS[0][1]),
                    'r-', linewidth=2)
...
def rrt(startnode, goalnode, visual):
    ...
    while True:
        ...
        if np.random.uniform() < 0.2:
            ...
            targetnode = Node(random.uniform(xmin, xmax), random.uniform(ymin, ymax), None)
        ...
        next_node_t = nearnode.t + TURN_TIME + random.uniform(dstep / VEL_MAX, dstep / MIN_VEL) 
...
def main():
    ...
    for trial in range(NUM_TRIALS):
        ...
        if SHOW_VISUAL:
            ...
            global SENTRY_EXPECTED_SPEED
            if trial == 0:
                SENTRY_EXPECTED_SPEED = 3
                WAYPOINTS = ((11, 3), (5, 3), (5, 7), (11, 7))
            elif trial == 1:
                WAYPOINTS = ((5, 7), (11, 7), (11, 3), (5, 3))
